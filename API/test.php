...
header('Content-Type: application/json');
	...
	$first_product = $generated_products[0];
	if (
		!isset($first_product['color_1']) || 
		!isset($first_product['color_2']) || 
		!isset($first_product['attribute_1']) || 
		!isset($first_product['attribute_2']) || 
		!isset($first_product['desc_short']) || 
		!isset($first_product['desc_long'])
	) {
